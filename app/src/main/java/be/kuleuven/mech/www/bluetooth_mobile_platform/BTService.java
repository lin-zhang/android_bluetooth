...
public class BTService extends Activity {
    ...
    // UUID for this application UUID
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(MainActivity.TOAST, "Failed to connect");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(MainActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(MainActivity.TOAST, getResources().getText(R.string.disconnect_label).toString());
        msg.setData(bundle);
        mHandler.sendMessage(msg);
